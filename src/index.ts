...
import { MedicalCollection } from "./MedicalCollection";

//  Création des collections
const consultations = new MedicalCollection<Consultation>();
const medicaments = new MedicalCollection<Medicament>();
const diagnostics = new MedicalCollection<Diagnostic>();
const traitements = new MedicalCollection<Traitement>();
...
const diag1 = new Diagnostic("d1", "2025-01-31", "Grippe sévère", "Élevée", "Respiratoire");


diagnostics.add(diag1);


const med1 = new Medicament("m1", "2014-01-20", "Paracétamol", "500mg");
const med2 = new Medicament("m2", "2019-12-15", "Ibuprofène", "200mg");
const med3 = new Medicament("m3", "2009-07-25", "Doliprane", "1000mg");
const med4 = new Medicament("m4", "2024-11-04", "Abacavir", "100mg");
...
const traitement1 = new Traitement("t1", "2025-01-30", "2025-02-10", ["Paracétamol", "Ibuprofène"]);
traitements.add(traitement1);

const consultation1 = new Consultation("c1", "2025-01-31", "Dr. Dupont");
consultation1.ajouterDiagnostic(diag1);
consultations.add(consultation1);

const consultation2 = new Consultation("c2", "2025-01-31", "Dr. Lefebvre");
...
console.log("\n Mise à jour d’un traitement (ajout d'un médicament pour combler l'Ibuprofène supprimé)");
...
const diag2 = new Diagnostic("d2", "2025-02-01", "Pneumonie", "Moyenne", "Respiratoire");
